...
(function () {
  ...
  var BBWS1oc = String(
    parameters["Window1 OutlineColor"] || "rgba(0, 0, 0, 0.5)"
  );
  var BBWS1ow = Number(parameters["Window1 OutlineWidth"] || "4");
  var BBWS2oc = String(
    parameters["Window2 OutlineColor"] || "rgba(0, 0, 0, 0.5)"
  );
  var BBWS2ow = Number(parameters["Window2 OutlineWidth"] || "4");
  var BBWS3oc = String(
    parameters["Window3 OutlineColor"] || "rgba(0, 0, 0, 0.5)"
  );
  var BBWS3ow = Number(parameters["Window3 OutlineWidth"] || "4");
  var BBWS1dm = String(
    parameters["Window1 DimmerColor"] || "rgba(0, 0, 0, 0.6)"
  );
  var BBWS2dm = String(
    parameters["Window1 DimGradationColor"] || "rgba(0, 0, 0, 0)"
  );
  var BBWS3dm = String(
    parameters["Window2 DimmerColor"] || "rgba(0, 0, 0, 0.6)"
  );
  var BBWS4dm = String(
    parameters["Window2 DimGradationColor"] || "rgba(0, 0, 0, 0)"
  );
  var BBWS5dm = String(
    parameters["Window3 DimmerColor"] || "rgba(0, 0, 0, 0.6)"
  );
  var BBWS6dm = String(
    parameters["Window3 DimGradationColor"] || "rgba(0, 0, 0, 0)"
  );

  // 画像の読み込み
  var _Scene_Boot_prototype_loadSystemWindowImage =
  ...
  var _Window_Base_prototype_updateBackgroundDimmer =
    Window_Base.prototype.updateBackgroundDimmer;
  ...
  var _Window_Base_prototype_refreshDimmerBitmap =
    Window_Base.prototype.refreshDimmerBitmap;
