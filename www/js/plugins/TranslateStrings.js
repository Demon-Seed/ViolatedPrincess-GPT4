...
(function () {
  ...
  Lang.reflectDataBase =
    Lang.Param["データベースを言語別に使用する"] == "true" ? true : false;
  Lang.reflectSentence =
    Lang.Param["文章を言語別に取得する"] == "true" ? true : false;
  ...
  DataManager._databaseFiles.push({
    name: "$gameStrings",
    src: Lang.dirName + "/GameStrings.json",
  });
  ...
  Window_MapName.prototype.refresh = function () {
    ...
    if ($gameMap.displayName()) {
      ...
      this.drawText(
        GameStrings.GetString($gameMap.displayName()),
        0,
        0,
        width,
        "center"
  ...
  Window_Command.prototype.drawItem = function (index) {
    ...
    this.drawText(
      GameStrings.GetString(this.commandName(index)),
      rect.x,
      rect.y,
      rect.width,
      align
  ...
  const _Game_Interpreter_prototype_terminate =
