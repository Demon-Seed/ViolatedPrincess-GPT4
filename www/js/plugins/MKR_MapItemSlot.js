...
(function () {
  ...
  Params = {
    SlotVisible: CheckParam(
      "bool",
      "Slot_Visible",
      Parameters["Slot_Visible"],
      true
    ),
    SlotOpacityOffset: CheckParam(
      "num",
      "Slot_Opacity_Offset",
      Parameters["Slot_Opacity_Offset"],
      16,
      1,
      255
    ),
    SlotBackground: CheckParam(
      "string",
      "Slot_Background",
      Parameters["Slot_Background"],
      ""
    ),
    SlotNumber: CheckParam(
      "num",
      "Slot_Number",
    ...
    SlotSetW: CheckParam(
      "bool",
      "Slot_Set_Weapon",
      Parameters["Slot_Set_Weapon"],
      true
    ),
    SlotSetA: CheckParam(
      "bool",
      "Slot_Set_Armor",
      Parameters["Slot_Set_Armor"],
      true
    ),
    SlotSetS: CheckParam(
      "bool",
      "Slot_Set_Skill",
      Parameters["Slot_Set_Skill"],
      false
    ),
    SlotCursorVisible: CheckParam(
      "bool",
      "Slot_Cursor_Visible",
      Parameters["Slot_Cursor_Visible"],
      true
    ),
    MapSlotOpacity: CheckParam(
      "num",
      "Map_Slot_Opacity",
      Parameters["Map_Slot_Opacity"],
      255,
      0,
      255
    ),
    SlotAddMode: CheckParam(
      "bool",
      "Slot_Add_Mode",
      Parameters["Slot_Add_Mode"],
      true
    ),
    ItemRemoveMode: CheckParam(
      "bool",
      "Item_Remove_Mode",
      Parameters["Item_Remove_Mode"],
      true
    ),
    ItemUseMode: CheckParam(
      "bool",
      "Item_Use_Mode",
      Parameters["Item_Use_Mode"],
      false
    ),
    ItemCountVisible: CheckParam(
      "bool",
      "Item_Count_Visible",
      Parameters["Item_Count_Visible"],
      true
    ),
    MenuSlotMode: CheckParam(
      "num",
      "Menu_Slot_Mode",
      Parameters["Menu_Slot_Mode"],
      "コマンド有効状態で追加"
    ),
    MenuBackground: CheckParam(
      "string",
      "Menu_Background",
      Parameters["Menu_Background"],
      ""
    ),
    MapBackgroundEnable: CheckParam(
      "bool",
      "Map_Background_Enable",
      Parameters["Map_Background_Enable"],
      false
    ),
    MenuSlotName: CheckParam(
      "string",
      "Menu_Slot_Name",
      Parameters["Menu_Slot_Name"],
      "アイテムスロット"
    ),
    SlotSetName: CheckParam(
      "string",
      "Slot_Set_Name",
      Parameters["Slot_Set_Name"],
      "登録"
    ),
    // "SlotChangeName" : CheckParam("string", "Slot_Change_Name", Parameters["Slot_Change_Name"], "入れ替え"),
    SlotRemoveName: CheckParam(
      "string",
      "Slot_Remove_Name",
      Parameters["Slot_Remove_Name"],
      "削除"
    ),
    SlotSetDesc: CheckParam(
      "string",
      "Slot_Set_Desc",
      Parameters["Slot_Set_Desc"],
      "アイテムを登録したいスロットを選択し、\n登録するアイテムを選択してください。"
    ),
    SlotChangeDesc: CheckParam(
      "string",
      "Slot_Change_Desc",
      Parameters["Slot_Change_Desc"],
      "移動元のスロットを選択し、\n交換先のスロットを選択してください。"
    ),
    SlotRemoveDesc: CheckParam(
      "string",
      "Slot_Remove_Desc",
      Parameters["Slot_Remove_Desc"],
      "アイテムの登録を解除するスロットを選択してください。"
    ),
    MenuSlotOpacity: CheckParam(
      "num",
      "Menu_Slot_Opacity",
      Parameters["Menu_Slot_Opacity"],
      255,
      0,
      255
    ),
    CategoryEnable: CheckParam(
      "bool",
      "Category_Enable",
      Parameters["Category_Enable"],
      true
    ),
    ...
    MapSlotWindow: {
      ...
      Padding: CheckParam(
        ...
        Parameters["Map_Slot_Window"]["Padding"],
        12,
        7
      ),
      Spacing: CheckParam(
        ...
        Parameters["Map_Slot_Window"]["Spacing"],
        6,
        0
      ),
      FontSize: CheckParam(
        "num",
        "Map_Slot_Window.Font_Size",
        Parameters["Map_Slot_Window"]["Font_Size"],
        20,
        6
      ),
    },
    MenuSlotWindow: {
      SizeRate: CheckParam(
        ...
        Parameters["Menu_Slot_Window"]["Size_Rate"],
        1.0,
        1.0,
        2.0
      ),
      Padding: CheckParam(
        ...
        Parameters["Menu_Slot_Window"]["Padding"],
        12,
        7
      ),
      Spacing: CheckParam(
        ...
        Parameters["Menu_Slot_Window"]["Spacing"],
        6,
        0
      ),
      FontSize: CheckParam(
        "num",
        "Menu_Slot_Window.Font_Size",
        Parameters["Map_Slot_Window"]["Font_Size"],
        20,
        6
      ),
    ...
    KeyConfig: {
      ItemUseKey: CheckParam(
        "string",
        "Item_Use_Key",
        Parameters["Item_Use_Key"]["Key"],
        "control",
        null,
        null,
        ["lower"]
      ...
      Slot9Key: CheckParam(
        "string",
        "Slot_9_Key",
        Parameters["Slot_9_Key"]["Key"],
        "9",
        null,
        null,
        ["lower"]
      ),
      Slot10Key: CheckParam(
        "string",
        "Slot_10_Key",
        Parameters["Slot_10_Key"]["Key"],
        "0",
        null,
        null,
        ["lower"]
    ...
    KeyboardMode: {
      UseEnable: CheckParam(
        "bool",
        "KeyboardMode.Use_Enable",
        Parameters["Keyboard_Mode"]["Use_Enable"],
        true
      ),
      SelectEnable: CheckParam(
        "bool",
        "KeyboardMode.Select_Enable",
        Parameters["Keyboard_Mode"]["Select_Enable"],
        true
      ),
    },
    MouseMode: {
      UseEnable: CheckParam(
        ...
        Parameters["Mouse_Mode"]["Use_Enable"],
        true
      ),
      SelectEnable: CheckParam(
        "bool",
        "MouseMode.Select_Enable",
        Parameters["Mouse_Mode"]["Select_Enable"],
        true
      ),
      DisplayClick: CheckParam(
        "num",
        "MouseMode.Display_Click",
        Parameters["Mouse_Mode"]["Display_Click"],
        1
      ),
    },
    EventMode: {
      SlotEnable: CheckParam(
        "bool",
        "EventMode.Slot_Enable",
        Parameters["Event_Mode"]["Slot_Enable"],
        false
      ),
      UseEnable: CheckParam(
        "bool",
        "EventMode.Use_Enable",
        Parameters["Event_Mode"]["Use_Enable"],
        false
      ),
      SelectEnable: CheckParam(
        "bool",
        "EventMode.Select_Enable",
        Parameters["Event_Mode"]["Select_Enable"],
        false
      ),
    },
  ...
  Window_Base.prototype.contentsContains = function (x, y) {
    ...
    if (
      this.x + padding <= x &&
      this.width + this.x - padding >= x &&
      this.y + padding <= y &&
      this.height + this.y - padding >= y
    ) {
      return true;
    }
  ...
  Game_Party.prototype.gainItem = function (item, amount, includeEquip) {
    ...
    if (Params.SlotAddMode[0] && meta.toLowerCase() != "noadd") {
      ...
      if (
        container &&
        this.hasItemType(item) &&
        this.getSlotEquipItem() != item
      ) {
  ...
  Game_Party.prototype.setItemSlot = function (index, item, equip) {
    ...
    if (
      ...
      this.getItemSlotNumber(ITEM, item.id) >= 0
    ) {
      index = -1;
    } else if (
      DataManager.isWeapon(item) &&
      this.getItemSlotNumber(WEAPON, item.id) >= 0
    ) {
      index = -1;
    } else if (
      DataManager.isArmor(item) &&
      this.getItemSlotNumber(ARMOR, item.id) >= 0
    ) {
      index = -1;
    } else if (
      DataManager.isSkill(item) &&
      this.getItemSlotNumber(SKILL, item.id) >= 0
    ) {
      index = -1;
    }
    ...
    if (item && index >= 0 && index < Params.SlotNumber[0]) {
      if (DataManager.isItem(item)) {
        ...
        if (
          (Params.SlotSetW[0] &&
            DataManager.isWeapon(item) &&
            actor.isEquipWtypeOk(item.wtypeId)) ||
          (Params.SlotSetA[0] &&
            DataManager.isArmor(item) &&
            actor.isEquipAtypeOk(item.atypeId))
        ) {
          equipFlg = actor.isEquipped(item);
          this._itemSlot[index] = {};
          this._itemSlot[index].id = item.id;
          this._itemSlot[index].type = DataManager.isWeapon(item)
            ? WEAPON
            : ARMOR;
  ...
  Game_Party.prototype.setSlotEquipItem = function (item) {
    if (item) {
      if (
        DataManager.getItemType(item) == WEAPON ||
        DataManager.getItemType(item) == ARMOR
      ) {
  ...
  Game_Party.prototype.useItemSlot = function (item) {
    ...
    if (
      ...
      item &&
      actor.canUse(item) &&
      (item.scope === 0 || this.isItemEffectsValid(item))
    ) {
      ...
      item &&
      (DataManager.getItemType(item) == ITEM ||
        DataManager.getItemType(item) == SKILL) &&
      Params.UseBuzzer[0]
    ) {
  ...
  Game_Actor.prototype.changeEquip = function (slotId, item) {
    ...
    if (
      this == $gameParty.leader() &&
      ((Params.SlotSetW[0] && DataManager.isWeapon(item)) ||
        (Params.SlotSetA[0] && DataManager.isArmor(item)))
    ) {
  ...
  Game_Actor.prototype.recoverySkills = function () {
    return this.skills().filter(function (skill) {
      return (
        skill &&
        skill.damage.type == 3 &&
        SKILLRANGE.contains(skill.scope) &&
        this.isSkillStypeOk(skill) &&
        this.skillTpCost(skill) == 0
      );
    }, this);
  };
    ...
    if (itemSlot) {
      ...
      if (item) {
        if (itemSlot.type == SKILL && this.needsSkillRedraw(item)) {
          ...
          if (
            this._type[index] != itemSlot.type ||
            this._num[index] != $gameParty.numItems(item)
          ) {
            return true;
          }
        }
  ...
  Window_ItemSlotBase.prototype.drawItemEx = function (index) {
    ...
    actor = $gameParty.leader();
    sizeRate = this._kind
      ? Params.MapSlotWindow.SizeRate[0]
      : Params.MenuSlotWindow.SizeRate[0];
  ...
  Window_ItemSlotBase.prototype.drawIconEx = function (
    iconIndex,
    x,
    y,
    sizeRate
  ...
  Window_ItemSlotBase.prototype.getTouchToIndex = function () {
    ...
    for (i = 0; i < Params.SlotNumber[0]; i++) {
      ...
      if (
        touchX >= x + rect.x + padding &&
        touchX <= x + rect.x + rect.width + padding
      ) {
        return i;
      }
      continue;
  ...
  Window_MapItemSlot.prototype.windowHeight = function () {
    let val;
    val =
      Window_ItemSlotBase.prototype.windowHeight.call(this) *
      Params.MapSlotWindow.SizeRate[0];
  ...
  Window_ItemSlotCategory.prototype = Object.create(
  ...
  Window_ItemSlotList.prototype.makeItemList = function () {
    ...
    if (
      (!Params.SlotSetW[0] && !Params.SlotSetA[0] && !Params.SlotSetS[0]) ||
      Params.CategoryEnable[0]
    ) {
  ...
  Window_ItemSlotList.prototype.drawSkillCost =
  ...
  Scene_Map.prototype.createMapItemSlotWindow = function () {
    ...
    this._mapItemSlotWindow = new Window_MapItemSlot(
      Params.SlotX[0],
      Params.SlotY[0],
      kind
    );
    ...
    if (Params.SlotBackground[0] != "") {
      this._mapItemSlotWindow._windowSpriteContainer.removeChild(
        this._mapItemSlotWindow._windowBackSprite
      );
      this._mapItemSlotWindow._windowSpriteContainer.removeChild(
        this._mapItemSlotWindow._windowFrameSprite
      );
      this._mapItemSlotWindow._windowBackSprite = new Sprite();
      this._mapItemSlotWindow._windowBackSprite.bitmap =
        ImageManager.loadPicture(Params.SlotBackground[0]);
      this._mapItemSlotWindow._windowSpriteContainer.addChild(
        this._mapItemSlotWindow._windowBackSprite
      );
    }
  ...
  Scene_Map.prototype.updateItemSlot = function () {
    ...
    if (isEnableEventToUse()) {
      if (
        isEnableMouseToUse(win) &&
        win.contentsContains(TouchInput.x, TouchInput.y)
      ) {
        win.callHandler("ok");
    ...
    if (
      itemSlot &&
      ((Params.SlotSetW[0] && itemSlot.type == WEAPON) ||
        (Params.SlotSetA[0] && itemSlot.type == ARMOR))
    ) {
    ...
    if (
      (itemSlot == null || itemSlot.type == ITEM) &&
      ((Params.SlotSetW[0] && actor.weapons().length > 0) ||
        (Params.SlotSetA[0] && actor.armors().length > 0))
    ) {
    ...
    if (Params.ItemRemoveMode[0]) {
      ...
      if (itemSlot) {
        if (
          (itemSlot.type == ITEM && $gameParty.numItems(item) <= 0) ||
          ((itemSlot.type == WEAPON || itemSlot.type == ARMOR) &&
            !actor.isEquipped(item))
        ) {
          $gameParty.removeItemSlot(index);
          win.redrawCurrentItem();
        }
  ...
  Scene_ItemSlot.prototype.createCommandWindow = function () {
    ...
    this._commandWindow.setHandler(
      "slotremove",
      this.commandItemSlot.bind(this)
    );
  ...
  Scene_ItemSlot.prototype.createItemSlotWindow = function () {
    ...
    if (Params.MapBackgroundEnable[0] && Params.SlotBackground[0] != "") {
      this._itemSlotWindow._windowSpriteContainer.removeChild(
        this._itemSlotWindow._windowBackSprite
      );
      this._itemSlotWindow._windowSpriteContainer.removeChild(
        this._itemSlotWindow._windowFrameSprite
      );
      this._itemSlotWindow._windowBackSprite = new Sprite();
      this._itemSlotWindow._windowBackSprite.bitmap = ImageManager.loadPicture(
        Params.SlotBackground[0]
      );
      this._itemSlotWindow._windowSpriteContainer.addChild(
        this._itemSlotWindow._windowBackSprite
      );
    }
  ...
  Scene_ItemSlot.prototype.createCategoryWindow = function () {
    ...
    this._categoryWindow.y =
      this._itemSlotWindow.y + this._itemSlotWindow.height;
  ...
  DataManager.extractSaveContents = function (contents) {
    ...
    if (
      $gameParty.getItemSlot(-1) == undefined ||
      $gameParty.getItemSlot(-1) == null
    ) {
  ...
  function codeToName(event) {
    ...
    if (event.key != undefined && event.key != null) {
      ...
      event.keyIdentifier != undefined &&
      event.keyIdentifier != null
    ) {
  ...
  function isEnableKeyboardToUse() {
    ...
    return keyboardMode.UseEnable[0] && paramKey && Input.isTriggered(paramKey)
      ? true
      : false;
  }
