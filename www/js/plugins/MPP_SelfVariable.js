...
(function (exports) {
  ...
  Game_Variables.prototype.setSelfVariable = function (
    mapId,
    eventId,
    variableId,
    value
  ...
  Game_Variables.prototype.deleteSelfVariables = function (
    mapId,
    evIds,
    vaIds
  ) {
    ...
    for (var key in this._selfVariables) {
      if (re.test(key)) {
        if (
          (evIds.length === 0 || evIds.includes(parseInt(RegExp.$1))) &&
  ...
  //55
  Alias.GaIn_setupReservedCommonEvent =
