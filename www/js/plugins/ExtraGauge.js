...
(() => {
  ...
  Scene_Base.prototype.createExtraGauges = function () {
    this._extraGauges = this.findExtraGaugeList().map((data) => {
      return new Sprite_ExtraGaugeContainer(
        data,
        data.Detail || {},
        data.Layout || {}
      );
  ...
  class Sprite_ExtraGaugeContainer extends Sprite {
    ...
    create() {
      this._gauge = new Sprite_ExtraGauge(
        this._data,
        this._detail,
        this._layout
      );
  ...
  class Sprite_ExtraGauge extends Sprite_Gauge {
    ...
    gaugeHeight() {
      return (
        this.findLayoutValue(this._layout.GaugeHeight) || this.bitmapHeight()
      );
    }
    ...
    labelOutlineColor() {
      return this.findColor(
        this.findLabelFont().OutlineColor,
        super.labelOutlineColor()
      );
    }
    ...
    valueOutlineColor() {
      return this.findColor(
        this.findValueFont().OutlineColor,
        super.valueOutlineColor()
      );
    }
