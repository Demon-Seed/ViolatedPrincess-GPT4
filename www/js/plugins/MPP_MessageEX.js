...
(() => {
  ...
  const param_TextInformations = JSON.parse(
    parameters["Text Informations"] || "{}",
    paramReplace
  );
  ...
  const param_DefaultRubyColor = "rgb(%1)".format(
  ...
  Window_Message.prototype.processEscapeCharacter = function (code, textState) {
    switch (code) {
      ...
      case "OP":
        ...
        break;
      case "OC":
        this.contents.outlineColor = this.obtainEscapeColor(
          textState,
          "rgba(0,0,0,0.5)"
        );
        break;
