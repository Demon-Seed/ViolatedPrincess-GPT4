...
(function () {
  ...
  var paramMinWidthVariableId = getParamNumber([
    "MinWidthVariableId",
    "最小横幅取得変数ID",
  ]);
  var paramMinHeightVariableId = getParamNumber([
    "MinHeightVariableId",
    "最小高さ取得変数ID",
  ]);
  ...
  Window_Base.prototype.adjustPopupPositionY = function () {
    var minY = this._pauseSignLower
      ? this._windowPauseSignSprite.height / 2
      : 0;
    ...
    var maxY =
      (paramUpperLimitY || Graphics.boxHeight) -
      this._windowPauseSignSprite.height / 2;
  ...
  var _Window_Message__createAllParts =
