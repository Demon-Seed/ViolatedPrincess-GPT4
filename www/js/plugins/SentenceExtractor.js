...
(function () {
  ...
  SentenceData.start = function () {
    ...
    let mapInfo = this._fs.readFileSync(
      this._projectFilePath + "/data/MapInfos.json"
    );
  ...
  SentenceData.saveText = function (dataStr, saveFileName) {
    ...
    let saveFilePath =
      this._projectFilePath + "/" + DIR_NAME + "/" + saveFileName + ".txt";
  ...
  SentenceData.saveCsv = function (dataStr, saveFileName) {
    let saveFilePath =
      this._projectFilePath + "/" + DIR_NAME + "/" + saveFileName + ".csv";
    let fs = this._fs;
    if (dataStr == "") {
  ...
  SentenceData.writeCommonSentence = function (typeNum) {
    ...
    var data = fs.readFileSync(
      this._projectFilePath + "/data/CommonEvents.json"
    );
