...
(function (Nore) {
  ...
  var _Sprite_Picture_prototype_makeDynamicBitmap =
    Sprite_Picture.prototype.makeDynamicBitmap;
  Sprite_Picture.prototype.makeDynamicBitmap = function () {
    this.removeBitmapText();
    this.bitmapTextList = [];
    _Sprite_Picture_prototype_makeDynamicBitmap.call(this);
  };
  var _Sprite_Picture_prototype_processText =
  ...
  Sprite_Picture.prototype.drawNumber = function drawNumber(
    num,
    x,
    y,
    w,
