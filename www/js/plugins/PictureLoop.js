...
function EraseLoopPicture(layer) {
  ...
  if ($gameScreen._pictures[realPictureId] != null)
    $gameScreen.erasePicture(layer);
}
//ループピクチャの情報作成
Game_Screen.prototype.CreateLoopPicture = function (
  layer,
  name,
  name2,
  origin,
  ...
  LoopPictureCount_rand[layer] = Math.floor(
    Math.random() * PictureloopCount2 + 1 + PictureloopCount1
  ); //瞬きの間隔を作成
};
...
//まばたき用ピクチャループ
Game_Screen.prototype.LoopPicture = function (
  layer,
  name,
  name2,
  origin,
